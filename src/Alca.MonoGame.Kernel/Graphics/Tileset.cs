...
public sealed class Tileset
{
    ...
    /// <summary>Gets the width, in pixels, of each tile in this tileset.</summary>
    public int TileWidth { get; }

    /// <summary>Gets the height, in pixels, of each tile in this tileset.</summary>
    public int TileHeight { get; }

    /// <summary>Gets the total number of columns in this tileset.</summary>
    public int Columns { get; }

    /// <summary>Gets the total number of rows in this tileset.</summary>
    public int Rows { get; }

    /// <summary>Gets the total number of tiles in this tileset.</summary>
    public int Count { get; }

    /// <summary>Creates a new tileset based on the given texture region with the specified tile width and height.</summary>
    ...
    /// <summary>Gets the texture region for the tile from this tileset at the given index.</summary>
    ...
    /// <summary>Gets the texture region for the tile from this tileset at the given location.</summary>
