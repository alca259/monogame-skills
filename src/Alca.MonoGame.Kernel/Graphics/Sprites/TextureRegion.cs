...
{
    /// <summary>Gets or Sets the source texture this texture region is part of.</summary>
    public Texture2D Texture { get; set; }

    /// <summary>Gets or Sets the source rectangle boundary of this texture region within the source texture.</summary>
    public Rectangle SourceRectangle { get; set; }

    /// <summary>Gets the width, in pixels, of this texture region.</summary>
    public int Width => SourceRectangle.Width;

    /// <summary>Gets the height, in pixels, of this texture region.</summary>
    public int Height => SourceRectangle.Height;

    /// <summary>Gets the top normalized texture coordinate of this region.</summary>
    public float TopTextureCoordinate => SourceRectangle.Top / (float)Texture.Height;

    /// <summary>Gets the bottom normalized texture coordinate of this region.</summary>
    public float BottomTextureCoordinate => SourceRectangle.Bottom / (float)Texture.Height;

    /// <summary>Gets the left normalized texture coordinate of this region.</summary>
    public float LeftTextureCoordinate => SourceRectangle.Left / (float)Texture.Width;

    /// <summary>Gets the right normalized texture coordinate of this region.</summary>
    ...
    /// <summary>Submit this texture region for drawing in the current batch.</summary>
