...
public sealed class Tilemap
{
    ...
    /// <summary>Gets the total number of rows in this tilemap.</summary>
    public int Rows { get; }

    /// <summary>Gets the total number of columns in this tilemap.</summary>
    public int Columns { get; }

    /// <summary>Gets the total number of tiles in this tilemap.</summary>
    public int Count { get; }

    /// <summary>Gets or Sets the scale factor to draw each tile at.</summary>
    public Vector2 Scale { get; set; }

    /// <summary>Gets the width, in pixels, each tile is drawn at.</summary>
    public float TileWidth => _tileset.TileWidth * Scale.X;

    /// <summary>Gets the height, in pixels, each tile is drawn at.</summary>
    public float TileHeight => _tileset.TileHeight * Scale.Y;

    /// <summary>Creates a new tilemap.</summary>
    ...
    /// <summary>Gets the texture region of the tile from this tilemap at the specified index.</summary>
    /// <param name="index">The index of the tile in this tilemap.</param>
    ...
    /// <summary>Gets the texture region of the tile frm this tilemap at the specified column and row.</summary>
    /// <param name="column">The column of the tile in this tilemap.</param>
    /// <param name="row">The row of the tile in this tilemap.</param>
    ...
    /// <summary>Draws this tilemap using the given sprite batch.</summary>
