...
public sealed class GamePadInfo
{
    ...
    /// <summary>Gets the index of the player this gamepad is for.</summary>
    public PlayerIndex PlayerIndex { get; }

    /// <summary>Gets the state of input for this gamepad during the previous update cycle.</summary>
    public GamePadState PreviousState { get; private set; }

    /// <summary>Gets the state of input for this gamepad during the current update cycle.</summary>
    public GamePadState CurrentState { get; private set; }

    /// <summary>Gets a value that indicates if this gamepad is currently connected.</summary>
    public bool IsConnected => CurrentState.IsConnected;

    /// <summary>Gets the value of the left thumbstick of this gamepad.</summary>
    public Vector2 LeftThumbStick => CurrentState.ThumbSticks.Left;

    /// <summary>Gets the value of the right thumbstick of this gamepad.</summary>
    public Vector2 RightThumbStick => CurrentState.ThumbSticks.Right;

    /// <summary>Gets the value of the left trigger of this gamepad.</summary>
    public float LeftTrigger => CurrentState.Triggers.Left;

    /// <summary>Gets the value of the right trigger of this gamepad.</summary>
    public float RightTrigger => CurrentState.Triggers.Right;

    /// <summary>Creates a new GamePadInfo for the gamepad connected at the specified player index.</summary>
    ...
    /// <summary>Returns a value that indicates whether the specified gamepad button is current down.</summary>
    ...
    /// <summary>Returns a value that indicates whether the specified gamepad button is currently up.</summary>
    /// <param name="button">The gamepad button to check.</param>
    ...
    /// <summary>Returns a value that indicates whether the specified gamepad button was just pressed on the current frame.</summary>
    /// <param name="button">The gamepad button to check.</param>
    ...
    /// <summary>Returns a value that indicates whether the specified gamepad button was just released on the current frame.</summary>
    /// <param name="button">The gamepad button to check.</param>
    ...
    /// <summary>Sets the vibration for all motors of this gamepad.</summary>
    ...
    /// <summary>Stops the vibration of all motors for this gamepad.</summary>
