...
{
    private static readonly Circle _empty = new();

    /// <summary> The x-coordinate of the center of this circle.</summary>
    public readonly int X;

    /// <summary>The y-coordinate of the center of this circle.</summary>
    public readonly int Y;

    /// <summary>The length, in pixels, from the center of this circle to the edge.</summary>
    public readonly int Radius;

    /// <summary>Gets the location of the center of this circle.</summary>
    public readonly Point Location => new(X, Y);

    /// <summary>Gets a circle with X=0, Y=0, and Radius=0.</summary>
    public static Circle Empty => _empty;

    /// <summary>Gets a value that indicates whether this circle has a radius of 0 and a location of (0, 0).</summary>
    public readonly bool IsEmpty => X == 0 && Y == 0 && Radius == 0;

    /// <summary>Gets the y-coordinate of the highest point on this circle.</summary>
    public readonly int Top => Y - Radius;

    /// <summary>Gets the y-coordinate of the lowest point on this circle.</summary>
    public readonly int Bottom => Y + Radius;

    /// <summary>Gets the x-coordinate of the leftmost point on this circle.</summary>
    public readonly int Left => X - Radius;

    /// <summary>Gets the x-coordinate of the rightmost point on this circle.</summary>
    public readonly int Right => X + Radius;

    /// <summary>Creates a new circle with the specified position and radius.</summary>
    ...
    /// <summary> Returns a value that indicates whether the specified circle intersects with this circle.</summary>
    ...
    /// <summary>Draws this circle to the specified sprite batch.</summary>
    ...
    /// <summary>Returns the hash code for this circle.</summary>
